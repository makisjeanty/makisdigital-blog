<x-app-layout>
    <x-slot name="header">Novo Post</x-slot>
    ...
    <div style="max-width: 860px;">
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <x-admin.card title="Informações do Post">
                <x-form.input name="title" label="Título" required placeholder="Título do seu post..."
                    class="form-input-lg" />
                ...
                <x-form.textarea name="excerpt" label="Resumo" rows="2"
                    placeholder="Um breve resumo do post (aparece na listagem)..." />
                <p class="form-help" style="margin-top: -1rem; margin-bottom: 1rem;">Opcional. Se vazio, será gerado
                    automaticamente do conteúdo.</p>

                <x-form.textarea name="content" id="content" label="Conteúdo" required rows="18"
            ...
            <x-admin.card style="margin-bottom: 1.5rem;">
                ...
                <div id="seo-fields" class="hidden">
                    <x-form.input name="meta_title" label="Meta Title" placeholder="Título SEO personalizado..." />
                    <x-form.textarea name="meta_description" label="Meta Description" rows="2"
            ...
            <x-admin.card title="Imagem de Capa">
                <div class="file-upload-zone" onclick="document.getElementById('image').click()">
                    ...
                    <p style="font-size: 0.9rem; color: #9ca3af; margin-bottom: 0.25rem;">
                        <span style="color: #a78bfa; font-weight: 600;">Clique para escolher</span> ou arraste uma
                        imagem
                    </p>
                    <p style="font-size: 0.75rem; color: #6b7280;">PNG, JPG, GIF, WEBP — Máximo 2MB</p>
                ...
                <div id="imagePreview" style="display: none; margin-top: 1rem;">
                    <div
                        ...
                        <button type="button" onclick="removeImage()" class="btn-icon" style="color: #f87171;">
                ...
                <div class="form-checkbox-wrapper">
                    ...
                    <div>
                        ...
                        <p style="font-size: 0.78rem; color: #6b7280; margin-top: 0.15rem;">
                            Se desmarcado, o post fica como rascunho (invisível no blog)
                        </p>
                    </div>
                </div>
            </x-admin.card>
